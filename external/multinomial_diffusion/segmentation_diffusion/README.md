...
``python train.py --eval_every 1 --check_every 25 --epochs 500 --log_home ./logs --diffusion_steps 4000 --dataset cityscapes_coarse --batch_size 32 --dp_rate 0.1 --augmentation shift --lr 0.0001 --warmup 5 --batch_size 64``
